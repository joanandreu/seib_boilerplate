...
use App\Http\Requests\Admin\CreateEntidadRequest;
use App\Http\Requests\Admin\UpdateEntidadRequest;
use App\Repositories\Admin\EntidadRepository;
...
class EntidadController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.entidads.index')
    ...
    {
        return view('admin.entidads.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.entidads.show')->with('entidad', $entidad);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.entidads.edit')->with('entidad', $entidad);
    }
